...
public class UserManagementApi {
    ...
    public ResponseEntity<UserLoginResponse> postLogin(@RequestBody ExternalUserLogin loginUserRequest) {
    ...
    public ResponseEntity<CustomerProfile> postEditWallet(@RequestBody CustomerProfileEditRequest customerProfileEditRequest) {
    ...
    public ResponseEntity<CustomerProfile> postListWallet(@RequestBody ListWalletRequest listWalletRequest) {
